...
function data_profile_page_path(string $productionPath): string
{
    ...
    static $map = [
        ...
        '/jazz-item-master/'                => '/jazz-item-master-uat/',
        '/po-receiving'                     => '/po-receiving-uat',
        '/po-receiving/'                    => '/po-receiving-uat/',
        '/po-receiving/index.php'           => '/po-receiving-uat/index.php',
        '/po-receiving/new.php'             => '/po-receiving-uat/new.php',
        '/po-receiving/edit.php'            => '/po-receiving-uat/edit.php',
        '/po-receiving/view.php'            => '/po-receiving-uat/view.php',
        '/po-receiving/delete.php'          => '/po-receiving-uat/delete.php',
        '/po-receiving/asn.php'             => '/po-receiving-uat/asn.php',
        '/po-receiving/transmit.php'        => '/po-receiving-uat/transmit.php',
        '/po-receiving/transmit-asn.php'    => '/po-receiving-uat/transmit-asn.php',
        '/po-receiving/receipt-asn.php'     => '/po-receiving-uat/receipt-asn.php',
        '/po-receiving/attachment.php'      => '/po-receiving-uat/attachment.php',
        '/po-receiving/upload-attachment.php' => '/po-receiving-uat/upload-attachment.php',
        '/po-receiving/jazz-asns.php'       => '/po-receiving/jazz-asns-uat.php',
        '/po-receiving/jazz-asn.php'        => '/po-receiving/jazz-asn-uat.php',
        '/delivery-scheduling-log'          => '/delivery-scheduling-log-uat',
        '/delivery-scheduling-log/'         => '/delivery-scheduling-log-uat/',
        '/delivery-scheduling-log/index.php'=> '/delivery-scheduling-log-uat/index.php',
        '/delivery-scheduling-log/new.php'  => '/delivery-scheduling-log-uat/new.php',
        '/delivery-scheduling-log/edit.php' => '/delivery-scheduling-log-uat/edit.php',
        '/delivery-scheduling-log/view.php' => '/delivery-scheduling-log-uat/view.php',
        '/delivery-scheduling-log/send-reminder.php' => '/delivery-scheduling-log-uat/send-reminder.php',
