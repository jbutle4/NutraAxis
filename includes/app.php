...
$inventoryManagementSubModules = [
    ...
    [
        'slug'  => 'inventory-balances-uat',
        'title' => 'Inventory Balances (UAT)',
        'desc'  => 'UAT System — IMS ledger balances by SKU and facility (sandbox profile).',
        'href'  => '/inventory-balances-uat/',
        'icon'  => 'inventory',
        'tier'  => 'uat',
        'sort'  => 240,
    ],
    [
        'slug'  => 'inventory-transfers-uat',
        'title' => 'Facility Transfers (UAT)',
        'desc'  => 'UAT System — Hub-and-spoke transfers against the sandbox IMS ledger.',
        'href'  => '/inventory-transfers-uat/',
        'icon'  => 'inventory',
        'tier'  => 'uat',
        'sort'  => 250,
    ],
    [
        'slug'  => 'inventory-adjustments-uat',
        'title' => 'Inventory Adjustments (UAT)',
        'desc'  => 'UAT System — Shrink/gain adjustments to sandbox IMS and QBO Sandbox.',
        'href'  => '/inventory-adjustments-uat/',
        'icon'  => 'inventory',
        'tier'  => 'uat',
        'sort'  => 260,
    ],
    [
        'slug'  => 'inventory-jazz-ims-recon-uat',
        'title' => 'Jazz vs IMS CART (UAT)',
        'desc'  => 'UAT System — Jazz UAT on-hand versus sandbox IMS CART balances.',
        'href'  => '/inventory-jazz-ims-recon-uat/',
        'icon'  => 'boxes',
        'tier'  => 'uat',
        'sort'  => 270,
    ],
    [
        'slug'  => 'inventory-jazz-ims-align-uat',
        'title' => 'Jazz → IMS CART Align (UAT)',
        'desc'  => 'UAT System — Align sandbox IMS CART from Jazz UAT (IMS only).',
        'href'  => '/inventory-jazz-ims-align-uat/',
        'icon'  => 'inventory',
        'tier'  => 'uat',
        'sort'  => 280,
    ],
    [
        'slug'  => 'inventory-qbo-recon-uat',
        'title' => 'QBO Inventory Reconciliation (UAT)',
        'desc'  => 'UAT System — Sandbox IMS totals vs QuickBooks Sandbox Qty on hand.',
        'href'  => '/inventory-qbo-recon-uat/',
        'icon'  => 'accounting',
        'tier'  => 'uat',
        'sort'  => 290,
    ],
    [
        'slug'  => 'inventory-movement-recon-uat',
        'title' => 'Movement Completeness (UAT)',
        'desc'  => 'UAT System — Receipt/sale/transfer/adjustment gaps for sandbox ledger.',
        'href'  => '/inventory-movement-recon-uat/',
        'icon'  => 'inventory',
        'tier'  => 'uat',
        'sort'  => 300,
    ],
...
$procurementSubModules = [
    ...
    [
        'slug'  => 'procurement-bids',
        'title' => 'Initiatives & Bids',
        'desc'  => 'Light RFPs and supplier estimates that do not become POs — award creates a draft/estimate invoice.',
    ...
    [
        ...
        'desc'  => 'Create vendor invoices with line detail, attachments, and QuickBooks Bill sync — including non-PO spend.',
    ...
    [
        ...
        'desc'  => 'Record check, ACH, and card payments against supplier invoices without a PO.',
...
$accountingSubModules = [
    ...
    [
        'slug'  => 'supplier-invoices-uat',
        'title' => 'Supplier Invoices (UAT)',
        'desc'  => 'UAT System — supplier invoices against the QuickBooks sandbox company.',
        'href'  => '/accounting/supplier-invoices-uat/',
        'icon'  => 'document',
        'tier'  => 'uat',
        'sort'  => 11,
    ],
    ...
    [
        'slug'  => 'invoice-payments-uat',
        'title' => 'Invoice Payments (UAT)',
        'desc'  => 'UAT System — invoice payments against the QuickBooks sandbox company.',
        'href'  => '/accounting/invoice-payments-uat/',
        'icon'  => 'payment',
        'tier'  => 'uat',
        'sort'  => 21,
    ],
    [
        ...
        'desc'  => 'Open bills and vendor balances from QuickBooks Production.',
    ...
    [
        'slug'  => 'qbo-accounts-payable-uat',
        'title' => 'Accounts Payable (UAT)',
        'desc'  => 'UAT System — open bills and vendor balances from QuickBooks Sandbox.',
    ...
    [
        ...
        'desc'  => 'Customer invoices and outstanding balances from QuickBooks Production.',
    ...
    [
        'slug'  => 'qbo-accounts-receivable-uat',
        'title' => 'Accounts Receivable (UAT)',
        'desc'  => 'UAT System — customer invoices from QuickBooks Sandbox.',
    ...
    [
        ...
        'desc'  => 'QuickBooks Production purchase orders and status.',
        'href'  => '/accounting/pos.php',
        'icon'  => 'accounting',
        'tier'  => 'production',
        'sort'  => 50,
    ...
    [
        'slug'  => 'qbo-purchase-orders-uat',
        'title' => 'Purchase Orders (UAT)',
        'desc'  => 'UAT System — QuickBooks Sandbox purchase orders and status.',
    ...
    [
        ...
        'desc'  => 'QuickBooks Production inventory items — SKU, pricing, quantity on hand.',
        'href'  => '/accounting/inventory.php',
        'icon'  => 'accounting',
        'tier'  => 'production',
        'sort'  => 60,
    ...
    [
        'slug'  => 'qbo-sku-master-uat',
        'title' => 'QBO SKU Master (UAT)',
        'desc'  => 'UAT System — QuickBooks Sandbox inventory items.',
    ...
    [
        'slug'  => 'qbo-suppliers',
        'title' => 'Suppliers',
        'desc'  => 'QuickBooks Production vendor directory and balances.',
        'href'  => '/accounting/suppliers.php',
        'icon'  => 'supplier',
        'tier'  => 'production',
        'sort'  => 70,
    ...
    [
        'slug'  => 'qbo-suppliers-uat',
        'title' => 'Suppliers (UAT)',
        'desc'  => 'UAT System — QuickBooks Sandbox vendor directory.',
    ...
    [
        ...
        'desc'  => 'General ledger accounts from QuickBooks Production.',
    ...
    [
        'slug'  => 'qbo-chart-of-accounts-uat',
        'title' => 'Chart of Accounts (UAT)',
        'desc'  => 'UAT System — general ledger accounts from QuickBooks Sandbox.',
...
$modulePages = [
    ...
    'procurement' => [
        ...
        'capabilities' => [
            ...
            ['title' => 'PO Payments', 'desc' => 'Payment requests against purchase orders.'],
            ['title' => 'Invoice Payments', 'desc' => 'Payments against supplier invoices without a PO.'],
