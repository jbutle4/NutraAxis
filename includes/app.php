...
$inventoryManagementSubModules = [
    ...
    [
        ...
        'title' => 'ACCS Current Inventory (stage)',
...
$modulePages = [
    ...
    'inventory-management' => [
        ...
        'lead'        => 'Monitor stock across systems, reconcile Jazz and ACCS, review sales demand, and plan replenishment.',
        'capabilities' => [
            ['title' => 'Product SKU Master', 'desc' => 'Canonical SKU codes, attributes, and catalog reference data.'],
            ['title' => 'Jazz Item Master', 'desc' => 'Jazz OMS item reference for reconciliation.'],
            ['title' => 'Jazz Current Inventory', 'desc' => 'Jazz OMS stock on hand by SKU and facility.'],
            ['title' => 'ACCS Current Inventory', 'desc' => 'Adobe Commerce inventory by SKU and source.'],
            ['title' => 'Inventory Reconciliation', 'desc' => 'Side-by-side Jazz vs ACCS quantity compare.'],
            ['title' => 'Daily Sales Summary', 'desc' => 'Daily SKU quantity totals from ACCS orders.'],
            ['title' => 'Monthly Sales Summary', 'desc' => 'Monthly SKU quantity totals from daily sales.'],
