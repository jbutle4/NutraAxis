...
const MODULE_PERMISSION_COLUMNS = [
    ...
    'inventory-transfers'        => 'InventoryReporting',
    ...
    'inventory-balances-uat'         => 'InventoryReporting',
    'inventory-transfers-uat'        => 'InventoryReporting',
    'inventory-adjustments-uat'      => 'InventoryReporting',
    'inventory-jazz-ims-recon-uat'   => 'InventoryReporting',
    'inventory-jazz-ims-align-uat'   => 'InventoryReporting',
    'inventory-qbo-recon-uat'        => 'InventoryReporting',
    'inventory-movement-recon-uat'   => 'InventoryReporting',
    'sales-reporting'        => 'SalesReporting',
    'accs-order-report'      => 'SalesReporting',
    'accs-order-report-uat'  => 'SalesReporting',
    'sales-rep-reporting'    => 'SalesReporting',
    'sales-rep-reporting-uat'=> 'SalesReporting',
    ...
    'sales-rep-territory-assignment' => 'SalesReporting',
    ...
    'qbo-accounts-payable-uat' => 'Accounting',
    'qbo-accounts-receivable'=> 'Accounting',
    'qbo-accounts-receivable-uat' => 'Accounting',
    'qbo-chart-of-accounts'  => 'Accounting',
    'qbo-chart-of-accounts-uat' => 'Accounting',
    'qbo-sku-master'         => 'Accounting',
    'qbo-sku-master-uat'     => 'Accounting',
    ...
    'invoice-payments-uat'   => 'Accounting',
...
function auth_permissions_from_role_row(array $row): array
{
    return [
        ...
        'EducationResources'   => $row['EducationResources'] ?? null,
        'Support'              => $row['Support'],
...
{
    if (function_exists('app_hub_slugs') && in_array($slug, app_hub_slugs(), true)) {
