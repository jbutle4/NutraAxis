...
function jazz_oms_is_production_environment(): bool
{
    ...
    // Default remains the shared UAT credentials unless a page opts into production.
    return false;
}
...
function jazz_oms_config_error(): ?string
{
    ...
    return jazz_oms_is_production_environment()
        ? 'Jazz OMS is not configured. Set JAZZ_DOMAIN_PROD, JAZZ_USERNAME_PROD, JAZZ_PASSWORD_PROD, and JAZZ_TENANT_CODE in application settings.'
        : 'Jazz OMS is not configured. Set JAZZ_DOMAIN, JAZZ_USERNAME, JAZZ_PASSWORD, and JAZZ_TENANT_CODE in application settings.';
}
