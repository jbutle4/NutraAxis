...
if (!por_can_edit($receipt)) {
    header('Location: ' . por_page_path('/po-receiving/view.php') . '?id=' . $porId . '&error=' . rawurlencode('This receipt has been transmitted and can no longer be edited.'), true, 302);
    exit;
}
