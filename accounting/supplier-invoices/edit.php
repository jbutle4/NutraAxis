...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !$isLocked) {
    ...
    if ($result['ok']) {
        header('Location: /accounting/supplier-invoices/view.php?id=' . $invoiceId . '&notice=updated', true, 302);
        exit;
    }
  ...
  <main class="page-main">
    <div class="container page-inner page-inner--wide">
      ...
      render_list_page_header([
          'back_href'  => '/accounting/supplier-invoices/view.php?id=' . $invoiceId,
      ...
      <?php
        ...
        $uploadReturnPath = '/accounting/supplier-invoices/edit.php?id=' . $invoiceId;
