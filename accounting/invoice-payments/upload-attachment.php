...
if ($result['ok']) {
    header('Location: /accounting/invoice-payments/edit.php?id=' . $paymentId . '&notice=attachment', true, 302);
    exit;
}

header('Location: /accounting/invoice-payments/edit.php?id=' . $paymentId . '&error=' . urlencode($result['error']), true, 302);
exit;
