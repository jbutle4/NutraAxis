...
|----------|------|--------------|-------------|----------------|
| **CART** | Mothership / 3PL | Yes | Jazz | After Jazz confirmation (ASN, adjustments import, transfer ship TBD) |
| **CPPC** | Spoke | No | Local | Immediate on portal workflow |
| **WLO** | Spoke | No | Local | Immediate on portal workflow |
