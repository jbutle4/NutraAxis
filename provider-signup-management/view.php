...
if ($application === null) {
    ...
    echo '<main class="page-main"><div class="container page-inner"><div class="page-hero"><h1>Application not found</h1><div class="module-actions"><a class="btn-secondary" href="/provider-signup-management/">Back to queue</a></div></div></div></main>';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $canUpdate) {
    ...
    $redirect = '/provider-signup-management/view.php?id=' . $applicationId;
  ...
  <main class="page-main">
    <div class="container page-inner">
      ...
      render_list_page_header([
          'back_href'  => '/provider-signup-management/',
      ...
      <div class="detail-grid">
        ...
        <section class="detail-card">
          ...
          <ul>
            ...
            <li>
              <a href="/provider-signup-management/attachment.php?id=<?= (int) $attachment['AttachmentID'] ?>">
      ...
      <?php if ($canUpdate): ?>
      <form class="admin-form" method="post" action="/provider-signup-management/view.php?id=<?= $applicationId ?>">
